...
s3_data_after_initial_transformation = ApplyMapping.apply(
    frame=s3_data_cleansed,
    mappings=[
        ("connex date", "string", "connex_date", "string"),
        ("connex time", "string", "connex_time", "string"),
        ("tran date", "string", "tran_date", "string"),
        ("tran time", "string", "tran_time", "string"),
        ("card number", "string", "card_number", "string"),
        ("seq", "string", "seq", "string"),
        ("tran amount", "string", "tran_amount", "string"),
        ("tran type", "string", "tran_type", "string"),
        ("proc code", "string", "proc_code", "string"),
        ("completion", "string", "completion", "string"),
        ("response", "string", "response", "string"),
        ("location", "string", "locale", "string"),
        ("source", "string", "source_type", "string"),
        ("entry mode", "string", "entry_mode", "string"),
        ("terminal id", "string", "terminal_id", "string"),
        ("retrieval ref", "string", "retrieval_ref", "string"),
        ("trace acq/iss", "string", "trace_acq_iss", "string"),
        ("auth code", "string", "auth_code", "string"),
        ("standin", "string", "standin", "string"),
        ("settle date", "string", "settle_date", "string"),
        ("date posted", "string", "date_posted", "string"),
        ("acq inst", "string", "acq_inst", "string"),
        ("card inst", "string", "card_inst", "string"),
        ("fwd inst", "string", "fwd_inst", "string"),
        ("intercept", "string", "intercept", "string"),
        ("processor", "string", "processor", "string"),
        ("merchant", "string", "merchant", "string"),
        ("merch type", "string", "merch_type", "string"),
        ("exp date", "string", "exp_date", "string"),
        ("suspect ind", "string", "suspect_ind", "string"),
        ("atm session id", "string", "atm_session_id", "string"),
        ("from acct", "string", "from_acct", "string"),
        ("to acct", "string", "to_acct", "string"),
    ],
